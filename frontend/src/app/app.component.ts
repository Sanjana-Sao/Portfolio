...
export class AppComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  projects: any[] = [
    ...
    },
    {
      ...
      icon: '◉', iconLabel: 'NLP',
      tags: ['IBM FOUNDATION MODELS', 'RAG'],
      description: 'Document-based Q&A chatbot built with IBM Foundation Models to extract answers from unstructured PDFs, DOCX, and TXT files.',
      links: [],
      color: 'green', featured: false,
      ref: 'PR5_01', deployStatus: 'PRODUCTION',
      liveTemp: '19.3°C', latency: '89ms',
      subtitle: 'DOCUMENT Q&A // IBM FOUNDATION MODELS',
      sidebarSub: 'DOCUMENT INTELLIGENCE',
      scope: 'This document-based Q&A chatbot uses IBM Foundation Models to extract answers from unstructured documents. Documents are embedded into Milvus for semantic search and vector-based retrieval, while a multitenant backend provides secure, role-based access with JWT authentication, Redis caching, and email verification.',
      steps: [
        { num: '01', title: 'DOCUMENT INGESTION', desc: 'Extracting content from unstructured PDF, DOCX, and TXT files' },
        { num: '02', title: 'VECTOR RETRIEVAL', desc: 'Embedding documents into Milvus for semantic search and contextual relevance' },
        { num: '03', title: 'SECURE MULTITENANCY', desc: 'JWT authentication, Redis caching, email verification, and role-based access control' },
      ],
      metric: { value: '3', label: 'SUPPORTED_DOCUMENT_FORMATS', note: '// PDF, DOCX, and TXT files supported for document-based Q&A.' },
      stack: ['IBM FOUNDATION MODELS', 'MILVUS', 'SEMANTIC SEARCH', 'JWT', 'REDIS', 'EMAIL VERIFICATION', 'RBAC'],
      contributions: [
        'Built a document-based Q&A chatbot using IBM Foundation Models for answers grounded in unstructured documents.',
        'Embedded PDF, DOCX, and TXT documents into Milvus for semantic search and vector-based retrieval with contextual relevance.',
        'Developed a multitenant backend with JWT authentication, Redis caching, email verification, and secure role-based access.',
      ],
      version: 'v.1.0-STABLE', buildFactor: '100%',
    },
  ];
